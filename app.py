...
#WORD VALIDATION (MIT List Download)
@st.cache_data  
def load_words():
    try:
        ...
        # Fallback backup words in case of no internet connection
...
# Displaying the last letter rule for the next word
...
if st.session_state.turn == "Player":
    ...
    if st.button("Submit Answer"):
        if player_guess == st.session_state.target_word:
            ...
            st.session_state.target_word = ""                 # Clear target for the next round
